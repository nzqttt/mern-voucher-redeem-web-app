        ...
        <div className="col-12">
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">VoucherId</label>
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">CompletedDate</label>
                <p className="m-0 ml-3">{_entity?.completedDate}</p>
              </div>
