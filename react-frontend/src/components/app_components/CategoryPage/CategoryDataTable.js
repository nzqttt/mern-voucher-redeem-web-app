...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.id}</p>
...
<Column field="id" header="Id" body={pTemplate1} filter={selectedFilterFields.includes("id")} hidden={selectedHideFields?.includes("id")}  sortable style={{ minWidth: "8rem" }} />
