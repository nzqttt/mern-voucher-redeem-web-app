...
const VouchersDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const editorTemplate6 = (rowData, { rowIndex }) => <div  dangerouslySetInnerHTML={{__html: rowData.termsCondition}}></div>
const p_booleanTemplate7 = (rowData, { rowIndex }) => <p >{String(rowData.isLatest)}</p>
...
<Column field="points" header="Points" body={p_numberTemplate2} filter={selectedFilterFields.includes("points")} hidden={selectedHideFields?.includes("points")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="termsCondition" header="Terms and Condition" body={editorTemplate6} filter={selectedFilterFields.includes("termsCondition")} hidden={selectedHideFields?.includes("termsCondition")}  sortable style={{ minWidth: "8rem" }} />
<Column field="isLatest" header="IsLatest" body={p_booleanTemplate7} filter={selectedFilterFields.includes("isLatest")} hidden={selectedHideFields?.includes("isLatest")}  style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Vouchers Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search Vouchers" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
