...
import seederData from "./vouchers.seeder.json";
...
const VouchersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VouchersSeederDialogComponent);
