    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Vouchers",
          type: "error",
          message: error.message || "Failed get Vouchers",
        });
      });
